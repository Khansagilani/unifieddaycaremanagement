...
export default function ParentMessages() {
    ...
    useEffect(() => {
        ...
        if (wsData && wsData.type === 'message' && selectedConversation) {
            setMessages(prev => [...prev, wsData.data])
        }
    }, [wsData, selectedConversation])
        ...
        <div className="p-6 h-screen flex flex-col max-w-4xl mx-auto">
            ...
            <div className="flex gap-6 flex-1 overflow-hidden">
                ...
                <div className="w-1/3 border rounded-lg overflow-y-auto">
                    <div className="p-4 bg-gray-50 font-semibold sticky top-0">Conversations with Staff</div>
                        ...
                        <>
                            ...
                            <form onSubmit={handleSendMessage} className="p-4 border-t flex gap-2">
                                <input
                                    ...
                                    placeholder="Type a message to the staff..."
